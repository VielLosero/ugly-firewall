...
#$iptables $ACTION_OUTPUT -o $out_int -p udp --dport 53 -m owner --uid-owner unbound -j LOG-FIL-OUT-ACCEPT
#$iptables $ACTION_OUTPUT -o $out_int -p tcp --dport 53 -m owner --uid-owner unbound -j LOG-FIL-OUT-ACCEPT
...
#$ip6tables $ACTION_OUTPUT -o $out_int -p udp --dport 53 -m owner --uid-owner unbound -j LOG-FIL-OUT-ACCEPT
#$ip6tables $ACTION_OUTPUT -o $out_int -p tcp --dport 53 -m owner --uid-owner unbound -j LOG-FIL-OUT-ACCEPT
